...
class AppTypography {
  ...
  // Heading Styles
  static TextStyle h1 = GoogleFonts.tajawal(
    fontSize: 32,
  ...
  static TextStyle h2 = GoogleFonts.tajawal(
    fontSize: 24,
    fontWeight: FontWeight.bold,
    letterSpacing: -0.3,
    height: 1.3,
  ...
  static TextStyle h3 = GoogleFonts.tajawal(
    fontSize: 20,
  ...
  // Label Text Styles
  static TextStyle labelLarge = GoogleFonts.tajawal(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    letterSpacing: 0.1,
  );
  ...
  static TextStyle labelSmall = GoogleFonts.tajawal(
    fontSize: 11,
    fontWeight: FontWeight.w500,
    letterSpacing: 0.5,
  );
